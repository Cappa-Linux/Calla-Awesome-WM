...
awful.keyboard.append_global_keybindings({
	...
	end, { description = "show this help window", group = "awesome" }),
	...
	end, { description = "open a file manager", group = "programs" }),
	awful.key({ mod }, "w", function()
		awful.spawn.with_shell("firefox")
	end, { description = "open firefox", group = "programs" }),
	...
	awful.key({ mod, "Control" }, "Print", function()
